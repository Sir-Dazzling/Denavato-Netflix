            ...
            <Header src="joker1" dontShowOnSmallViewPort>
                <Header.Frame>
                    <Header.Group>
                        ...
                        <Header.TextLink active={category === 'series' && 'true'}
                            onClick={() => {setCategory('series')}}>Series</Header.TextLink>
                        <Header.TextLink active={category === 'films' && 'true'}
                ...
                <Header.Feature>
                    ...
                    <Header.Text>
                    “Joker” is an original, standalone story of a man disregarded by society. A clown-for-hire by day, 
